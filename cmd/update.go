...
func NewUpdate(parent *cobra.Command, client *client.APIClient) *Update {
	var updateCmd = &cobra.Command{
		Use:                   "update [OPTIONS]",
		Short:                 "Update different resources",
		DisableFlagsInUseLine: true,
		Long:                  `TODO`,
		Example:               "# Update a deployment resource from file \n  gxctl update -f deployment_new.json",
	...
	updateCmd.Flags().StringP("filename", "f", "", "Filename or directory to file to use to update the resource")

	updateCmd.SetHelpTemplate(template.HelpTemplate())
	updateCmd.SetUsageTemplate(template.UsageTemplate())
