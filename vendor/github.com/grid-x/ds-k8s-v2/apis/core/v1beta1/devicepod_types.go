...
// DevicePod is the Schema for the devicepods API
type DevicePod struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   DevicePodSpec   `json:"spec,omitempty"`
	Status DevicePodStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true
// +kubebuilder:subresource:status
// DevicePodList contains a list of DevicePod
type DevicePodList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DevicePod `json:"items"`
}

func init() {
	SchemeBuilder.Register(&DevicePod{}, &DevicePodList{})
}
