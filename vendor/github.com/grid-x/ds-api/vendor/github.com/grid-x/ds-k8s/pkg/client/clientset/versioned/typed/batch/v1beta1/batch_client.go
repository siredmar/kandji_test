...
// BatchV1beta1Client is used to interact with features provided by the batch.gridx.ai group.
type BatchV1beta1Client struct {
	restClient rest.Interface
}

func (c *BatchV1beta1Client) DeviceJobs(namespace string) DeviceJobInterface {
	return newDeviceJobs(c, namespace)
}
