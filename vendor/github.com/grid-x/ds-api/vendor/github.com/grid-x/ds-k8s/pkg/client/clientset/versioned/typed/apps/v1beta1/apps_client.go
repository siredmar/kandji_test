...
type AppsV1beta1Interface interface {
	...
	DeviceApplicationsGetter
	DeviceDeploymentsGetter
}

// AppsV1beta1Client is used to interact with features provided by the apps.gridx.ai group.
type AppsV1beta1Client struct {
	restClient rest.Interface
}

func (c *AppsV1beta1Client) DeviceApplications(namespace string) DeviceApplicationInterface {
	return newDeviceApplications(c, namespace)
}

func (c *AppsV1beta1Client) DeviceDeployments(namespace string) DeviceDeploymentInterface {
	return newDeviceDeployments(c, namespace)
}
