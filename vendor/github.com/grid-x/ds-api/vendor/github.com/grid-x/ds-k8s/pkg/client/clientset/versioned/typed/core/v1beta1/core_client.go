...
// CoreV1beta1Client is used to interact with features provided by the core.gridx.ai group.
type CoreV1beta1Client struct {
	restClient rest.Interface
}

func (c *CoreV1beta1Client) Devices(namespace string) DeviceInterface {
	return newDevices(c, namespace)
}

func (c *CoreV1beta1Client) DevicePods(namespace string) DevicePodInterface {
	return newDevicePods(c, namespace)
}
