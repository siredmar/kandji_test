...
func mkWindowWeekday(wd time.Weekday) *time.Weekday {
...
func parseWindowWeekday(s string) (*time.Weekday, error) {
	...
	case "mon":
		return mkWindowWeekday(time.Monday), nil
	case "tue":
		return mkWindowWeekday(time.Tuesday), nil
	case "wed":
		return mkWindowWeekday(time.Wednesday), nil
	case "thu":
		return mkWindowWeekday(time.Thursday), nil
	case "fri":
		return mkWindowWeekday(time.Friday), nil
	case "sat":
		return mkWindowWeekday(time.Saturday), nil
	case "sun":
		return mkWindowWeekday(time.Sunday), nil
	}
